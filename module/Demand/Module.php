...
use Demand\Entity\Account;
use Demand\Entity\AccountTable;
        ...
        return array(
            'factories' => array(
                ...
                'AuthService' => function($sm) {
                    ...
                    'Demand\Entity\AccountTable' =>  function($sm) {
                        ...
                        'AccountTableGateway' => function ($sm) {
                            ...
                            return new TableGateway('stsn_accounts', $dbAdapter, null, $resultSetPrototype);
                        }
        ),
        );
    }
